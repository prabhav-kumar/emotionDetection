...
import PatientMainGuide from './patient_main/PatientMainGuide'
  ...
  return (
    <NotificationProvider>
      ...
      <Routes>
        ...
        <Route path="/patient_main/PatientMainGuide" element={<ProtectedRoute element={PatientMainGuide} userRole="patient" />} />      
      </Routes>
      </Router>
    </NotificationProvider>
  )
